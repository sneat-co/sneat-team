...
export interface ITeamAppState {
  collapsedGroups: string[];
  showWatched: boolean;
}

export abstract class ITeamAppStateService extends LocalAppState<ITeamAppState> {
...
@Injectable()
export class TeamAppStateService extends ITeamAppStateService {
  constructor() {
