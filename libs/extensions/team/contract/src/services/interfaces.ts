...
// export abstract class IListService extends ICommuneItemService<IListDto, TeamAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, TeamAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<TeamAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class ITeamService extends RxStoreService<TeamAppSchema> {
